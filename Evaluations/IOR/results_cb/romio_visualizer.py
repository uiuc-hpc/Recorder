...
# parameters = ["cb_config_list",  "romio_cb_write", "ind_rd_buffer_size"]
...
#     bw_2M = []
#     bw_1M = []
#     if parameter == "cb_config_list" or parameter == "ind_rd_buffer_size":
#         modes = ["base", "first", "second", "third", "fourth"]
#     elif parameter == "cb_buffer_size":
#         modes = ["base", "first", "second", "third"]
#     elif parameter == "romio_cb_write" or parameter == "romio_ds_write":
...
access = 'write'
modes = ["base", "first", "second"]
categories = ["Default - romio_cb_write=automatic", "romio_cb_write=enable", "romio_cb_write=disable"]
...
sns.barplot(ax=axes[0], x=categories, y=times_1, yerr=variance_1, 
                    capsize=5, palette=custom_colors, edgecolor="black", linewidth=0)

for i, (bandwidth, error) in enumerate(zip(times_1, variance_1)):
    axes[0].text(i, bandwidth + 1.0, f"±{round(error, 3)}", ha='center', fontsize=11, fontweight='bold')
...
axes[0].legend(handles, categories, loc="upper center", ncol=1, fontsize=9, frameon=True, bbox_to_anchor=(0.5, -0.05))
## cb_config_list
...
parameter = "cb_config_list"
access = 'write'
modes = ["base", "first", "second", "third", "fourth"]
categories = ["Default - cb_config_list *:1", "cb_config_list *:2", "cb_config_list *:4", "cb_config_list *:8", "cb_config_list *:16"]
...
sns.barplot(ax=axes[1], x=categories, y=times_1, yerr=variance_1, 
                    capsize=5, palette=custom_colors, edgecolor="black", linewidth=0)

for i, (bandwidth, error) in enumerate(zip(times_1, variance_1)):
    ax=axes[1].text(i, bandwidth + 1.0, f"±{round(error, 3)}", ha='center', fontsize=11, fontweight='bold')

axes[1].set_xticklabels([]) 
axes[1].set_xlabel("")
handles = [plt.Rectangle((0, 0), 1, 1, color=color, edgecolor="black") for color in custom_colors]
axes[1].legend(handles, categories, loc="upper center", ncol=2, fontsize=9, frameon=True, bbox_to_anchor=(0.5, -0.05))
## cb_buffer_size
...
parameter = "cb_buffer_size"
access = 'write'
modes = ["base", "first", "second", "third"]
categories = ["Default - cb_buffer_size=16M", "cb_buffer_size=8M", "cb_buffer_size=4M", "cb_buffer_size=2M"]
custom_colors = ["#1f77b4", "#ff7f0e", "#008000", "#d62728"]  # Blue, Orange, Green
...
std_time_first = np.std(array_data, axis=0)
avg_time_first = np.mean(array_data, axis=0)
# print(avg_time_first)

array_data = np.array(time_second)
std_time_second = np.std(array_data, axis=0)
avg_time_second = np.mean(array_data, axis=0)
# print(avg_time_second)

array_data = np.array(time_third)
std_time_third = np.std(array_data, axis=0)
avg_time_third = np.mean(array_data, axis=0)
# print(avg_time_third)

times_1 = [avg_time_base, avg_time_first, avg_time_second, avg_time_third]
variance_1 = [std_time_base, std_time_first, std_time_second, std_time_third]
sns.barplot(ax=axes[2], x=categories, y=times_1, yerr=variance_1, 
                    capsize=5, palette=custom_colors, edgecolor="black", linewidth=0)

for i, (bandwidth, error) in enumerate(zip(times_1, variance_1)):
    axes[2].text(i, bandwidth + 1.0, f"±{round(error, 3)}", ha='center', fontsize=11, fontweight='bold')

axes[2].set_xticklabels([]) 
axes[2].set_xlabel("")

handles = [plt.Rectangle((0, 0), 1, 1, color=color, edgecolor="black") for color in custom_colors]
axes[2].legend(handles, categories, loc="upper center", ncol=2, fontsize=9, frameon=True, bbox_to_anchor=(0.5, -0.05))
...
fig, axes = plt.subplots(1, 3, figsize=(15, 5), sharey=True)
parameter = "romio_cb_read"
access = 'read'
modes = ["base", "first", "second"]
categories = ["Default - romio_cb_read=automatic", "romio_cb_read=enable", "romio_cb_read=disable"]
custom_colors = ["#1f77b4", "#ff7f0e", "#008000"]  # Blue, Orange, Green
...
std_time_enable = np.std(array_data, axis=0)
avg_time_enable = np.mean(array_data, axis=0)
print(avg_time_enable)

array_data = np.array(time_disable)
std_time_disable = np.std(array_data, axis=0)
avg_time_disable = np.mean(array_data, axis=0)
print(avg_time_disable)
...
for i, (bandwidth, error) in enumerate(zip(times_1, variance_1)):
    axes[3].text(i, bandwidth + 1.0, f"±{round(error, 3)}", ha='center', fontsize=11, fontweight='bold')
...
axes[3].set_xlabel("")
handles = [plt.Rectangle((0, 0), 1, 1, color=color, edgecolor="black") for color in custom_colors]
axes[3].legend(handles, categories, loc="upper center", ncol=1, fontsize=9, frameon=True, bbox_to_anchor=(0.5, -0.05))
