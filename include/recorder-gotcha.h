...
#define GOTCHA_WRAP(func, ret, args)                                \
    ...
    typedef ret (*fptr_type_##func) args;                           \
    ret (*real_##func) args;                                        \
    ret wrapper_##func args;
...
/*
#define GOTCHA_WRAP(func, ret, args)                                \
    static gotcha_wrappee_handle_t GOTCHA_WRAPPEE_HANDLE(func);      \
    typedef ret (*GOTCHA_WRAPPER_TYPE(func)) args;                  \
    static GOTCHA_WRAPPER_TYPE(func) RECORDER_REAL_CALL(func);
*/
